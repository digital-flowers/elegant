...
new Interceptor(1, "request").execute(function () {
    ...
    this.export("METHOD", this.method, true);
    this.export("GET", this.get, true);
    this.export("POST", this.post, true);
    this.export("PARAMS", this.params, true);
    this.export("ARGS", this.args, true);
    this.export("PATH", this.path, true);
    this.export("EXTENSION", this.extension, true);
});