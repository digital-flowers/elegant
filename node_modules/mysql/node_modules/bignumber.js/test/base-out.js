var count = (function baseOut(BigNumber) {
    ...
    T('340', '95', 5);
    T('2', '2', 12);
    T('jfb98e91hdhd146', '730834824992077156981', 25);
    ...
    assertException(function () {
        new BigNumber('2').toString(0)
    }, "('2').toString(0)");
    assertException(function () {
        new BigNumber('2').toString(1)
    }, "('2').toString(1)");
    assertException(function () {
        new BigNumber('1').toString('-2')
    }, "('1').toString('-2')");
    assertException(function () {
        new BigNumber('1').toString('1.9')
    }, "('1').toString('1.9')");
    assertException(function () {
        new BigNumber('1.23').toString(36.01)
    }, "('1.23').toString(36.01)");
    assertException(function () {
        new BigNumber('1.23').toString(37)
    }, "('1.23').toString(37)");

    assertException(function () {
        new BigNumber('1.23').toString(NaN)
    }, "('1.23').toString(NaN)");
    assertException(function () {
        new BigNumber('1.23').toString('NaN')
    }, "('1.23').toString('NaN')");
    assertException(function () {
        new BigNumber('1.23').toString([])
    }, "('1.23').toString([])");
    assertException(function () {
        new BigNumber('1.23').toString({})
    }, "('1.23').toString({})");
    ...
    assertException(function () {
        new BigNumber('1.23').toString('hello')
    }, "('1.23').toString('hello')");
    assertException(function () {
        new BigNumber('1.23').toString('\t')
    }, "('1.23').toString('\t')");
    assertException(function () {
        new BigNumber('1.23').toString(new Date)
    }, "('1.23').toString(new Date)");
    assertException(function () {
        new BigNumber('1.23').toString(new RegExp)
    }, "('1.23').toString(new RegExp)");
    assertException(function () {
        new BigNumber('1.23').toString(2.01)
    }, "('1.23').toString(2.01)");
    assertException(function () {
        new BigNumber('1.23').toString(10.5)
    }, "('1.23').toString(10.5)");
    assertException(function () {
        new BigNumber('1.23').toString(true)
    }, "('1.23').toString(true)");
    assertException(function () {
        new BigNumber('1.23').toString(false)
    }, "('1.23').toString(false)");
    assertException(function () {
        new BigNumber('1.23').toString(function () {
        })
