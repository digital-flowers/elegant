var count = (function config(BigNumber) {
    ...
    assertException(function () {
        BigNumber.config({DECIMAL_PLACES: 0.1})
    }, "DECIMAL_PLACES : 0.1");
    assertException(function () {
        BigNumber.config({DECIMAL_PLACES: 1.1})
    }, "DECIMAL_PLACES : 1.1");
    assertException(function () {
        BigNumber.config({DECIMAL_PLACES: -1.1})
    }, "DECIMAL_PLACES : -1.1");
    assertException(function () {
        BigNumber.config({DECIMAL_PLACES: 8.1})
    }, "DECIMAL_PLACES : 8.1");
    assertException(function () {
        BigNumber.config({DECIMAL_PLACES: 1e+9 + 1})
    }, "DECIMAL_PLACES : 1e9 + 1");
    assertException(function () {
    ...
    assertException(function () {
        BigNumber.config({DECIMAL_PLACES: 'hi'})
    }, "DECIMAL_PLACES : 'hi'");
    assertException(function () {
        BigNumber.config({DECIMAL_PLACES: '1e+9'})
    }, "DECIMAL_PLACES : '1e+9'");
    assertException(function () {
        BigNumber.config({DECIMAL_PLACES: NaN})
    }, "DECIMAL_PLACES : NaN");
    assertException(function () {
        BigNumber.config({DECIMAL_PLACES: Infinity})
    }, "DECIMAL_PLACES : Infinity");
    ...
    assertException(function () {
        BigNumber.config({ROUNDING_MODE: 0.1})
    }, "ROUNDING_MODE : 0.1");
    assertException(function () {
        BigNumber.config({ROUNDING_MODE: 1.1})
    }, "ROUNDING_MODE : 1.1");
    assertException(function () {
        BigNumber.config({ROUNDING_MODE: -1.1})
    }, "ROUNDING_MODE : -1.1");
    assertException(function () {
        BigNumber.config({ROUNDING_MODE: 8.1})
    }, "ROUNDING_MODE : 8.1");
    assertException(function () {
        BigNumber.config({ROUNDING_MODE: 9})
    }, "ROUNDING_MODE : 9");
    assertException(function () {
        BigNumber.config({ROUNDING_MODE: 11})
    }, "ROUNDING_MODE : 11");
    assertException(function () {
    ...
    assertException(function () {
        BigNumber.config({ROUNDING_MODE: 'hi'})
    }, "ROUNDING_MODE : 'hi'");
    assertException(function () {
        BigNumber.config({ROUNDING_MODE: NaN})
    }, "ROUNDING_MODE : NaN");
    assertException(function () {
        BigNumber.config({ROUNDING_MODE: Infinity})
    }, "ROUNDING_MODE : Infinity");
    ...
    assertException(function () {
        BigNumber.config({EXPONENTIAL_AT: [0.1, 1]})
    }, "EXPONENTIAL_AT : [0.1, 1]");
    assertException(function () {
        BigNumber.config({EXPONENTIAL_AT: [-1, -0.1]})
    }, "EXPONENTIAL_AT : [-1, -0.1]");
    assertException(function () {
        BigNumber.config({EXPONENTIAL_AT: [1, 1]})
    }, "EXPONENTIAL_AT : [1, 1]");
    assertException(function () {
        BigNumber.config({EXPONENTIAL_AT: [-1, -1]})
    }, "EXPONENTIAL_AT : [-1, -1]");
    assertException(function () {
        BigNumber.config({EXPONENTIAL_AT: 1e9 + 1})
    }, "EXPONENTIAL_AT : 1e9 + 1");
    assertException(function () {
        BigNumber.config({EXPONENTIAL_AT: -1e9 - 1})
    }, "EXPONENTIAL_AT : -1e9 - 1");
    assertException(function () {
        BigNumber.config({EXPONENTIAL_AT: [-1e9 - 1, 1e9]})
    }, "EXPONENTIAL_AT : [-1e9 - 1, 1e9]");
    assertException(function () {
        BigNumber.config({EXPONENTIAL_AT: [-1e9, 1e9 + 1]})
    }, "EXPONENTIAL_AT : [-1e9, 1e9 + 1]");
    assertException(function () {
        BigNumber.config({EXPONENTIAL_AT: [1e9 + 1, -1e9 - 1]})
    }, "EXPONENTIAL_AT : [1e9 + 1, -1e9 - 1]");
    assertException(function () {
        BigNumber.config({EXPONENTIAL_AT: [-Infinity, Infinity]})
    }, "EXPONENTIAL_AT : [Infinity, -Infinity]");
    assertException(function () {
        BigNumber.config({EXPONENTIAL_AT: [Infinity, -Infinity]})
    }, "EXPONENTIAL_AT : [Infinity, -Infinity]");
    ...
    assertException(function () {
        BigNumber.config({RANGE: [-0.9, 1]})
    }, "RANGE : [-0.9, 1]");
    assertException(function () {
        BigNumber.config({RANGE: [-1, 0.9]})
    }, "RANGE : [-1, 0.9]");
    assertException(function () {
        BigNumber.config({RANGE: [0, 1]})
    }, "RANGE : [0, 1]");
    assertException(function () {
        BigNumber.config({RANGE: [-1, 0]})
    }, "RANGE : [-1, 0]");
    assertException(function () {
        BigNumber.config({RANGE: 0})
    }, "RANGE : 0");
    assertException(function () {
        BigNumber.config({RANGE: 1e9 + 1})
    }, "RANGE : 1e9 + 1");
    assertException(function () {
        BigNumber.config({RANGE: -1e9 - 1})
    }, "RANGE : -1e9 - 1");
    assertException(function () {
        BigNumber.config({RANGE: [-1e9 - 1, 1e9 + 1]})
    }, "RANGE : [-1e9 - 1, 1e9 + 1]");
    assertException(function () {
        BigNumber.config({RANGE: [1e9 + 1, -1e9 - 1]})
    }, "RANGE : [1e9 + 1, -1e9 - 1]");
    assertException(function () {
        BigNumber.config({RANGE: Infinity})
    }, "RANGE : Infinity");
    assertException(function () {
        BigNumber.config({RANGE: "-Infinity"})
    }, "RANGE : '-Infinity'");
    assertException(function () {
        BigNumber.config({RANGE: [-Infinity, Infinity]})
    ...
    assertException(function () {
        BigNumber.config({ERRORS: 0.1})
    }, "ERRORS : 0.1");
    assertException(function () {
        BigNumber.config({ERRORS: 1.1})
    }, "ERRORS : 1.1");
    assertException(function () {
        BigNumber.config({ERRORS: []})
    }, "ERRORS : []");
    assertException(function () {
        BigNumber.config({ERRORS: {}})
    }, "ERRORS : {}");
    ...
    assertException(function () {
        BigNumber.config({ERRORS: NaN})
    }, "ERRORS : NaN");
    assertException(function () {
        BigNumber.config({ERRORS: Infinity})
    }, "ERRORS : Infinity");
