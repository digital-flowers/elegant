var count = (function toExponential(BigNumber) {
    ...
    assertException(function () {
        new BigNumber('1.23').toExponential(NaN)
    }, "('1.23').toExponential(NaN)");
    assertException(function () {
        new BigNumber('1.23').toExponential('NaN')
    }, "('1.23').toExponential('NaN')");
    assertException(function () {
        new BigNumber('1.23').toExponential([])
    }, "('1.23').toExponential([])");
    assertException(function () {
        new BigNumber('1.23').toExponential({})
    }, "('1.23').toExponential({})");
    ...
    assertException(function () {
        new BigNumber('1.23').toExponential('hello')
    }, "('1.23').toExponential('hello')");
    assertException(function () {
        new BigNumber('1.23').toExponential('\t')
    }, "('1.23').toExponential('\t')");
    assertException(function () {
        new BigNumber('1.23').toExponential(new Date)
    }, "('1.23').toExponential(new Date)");
    assertException(function () {
        new BigNumber('1.23').toExponential(new RegExp)
    }, "('1.23').toExponential(new RegExp)");
    assertException(function () {
        new BigNumber('1.23').toExponential(2.01)
    }, "('1.23').toExponential(2.01)");
    assertException(function () {
        new BigNumber('1.23').toExponential(10.5)
    }, "('1.23').toExponential(10.5)");
    assertException(function () {
        new BigNumber('1.23').toExponential('1.1e1')
    }, "('1.23').toExponential('1.1e1')");
    assertException(function () {
        new BigNumber('1.23').toExponential(true)
    }, "('1.23').toExponential(true)");
    assertException(function () {
        new BigNumber('1.23').toExponential(false)
    }, "('1.23').toExponential(false)");
    assertException(function () {
        new BigNumber('1.23').toExponential(function () {
        })
    }, "('1.23').toExponential(function (){})");

    assertException(function () {
        new BigNumber(12.3).toExponential('-1')
    }, ".toExponential('-1')");
    assertException(function () {
        new BigNumber(12.3).toExponential(-23)
    }, ".toExponential(-23)");
    assertException(function () {
        new BigNumber(12.3).toExponential(1e9 + 1)
    }, ".toExponential(1e9 + 1)");
    assertException(function () {
        new BigNumber(12.3).toExponential(1e9 + 0.1)
    }, ".toExponential(1e9 + 0.1)");
    assertException(function () {
        new BigNumber(12.3).toExponential(-0.01)
    }, ".toExponential(-0.01)");
    assertException(function () {
        new BigNumber(12.3).toExponential('-1e-1')
    }, ".toExponential('-1e-1')");
    assertException(function () {
        new BigNumber(12.3).toExponential(Infinity)
    }, ".toExponential(Infinity)");
    assertException(function () {
        new BigNumber(12.3).toExponential('-Infinity')
    }, ".toExponential('-Infinity')");
