var count = (function pow(BigNumber) {
    ...
    // Note: Out of range exponents become +-Infinity,
    // so the result will not match Math.pow.
    T(Infinity, -0, -10000000001);          // Math.pow(-0, -10000000001) == -Infinity
    ...
    T(-0.00001, -0.00001, 1.1);
    T(-100000, -0.00001, -1.1);

    T(-Infinity, 1 / -0, 1);
    T(Infinity, 1 / -0, 10000000001);         // Math.pow(1/-0, 10000000001) == -Infinity
    ...
    T(Infinity, 2, 1e6 + 1);
    T(0, 2, -1e6 - 1);
    T(Infinity, -2, 1e6 + 1); // Test 75    // Math.pow(-2, 1e6 + 1) == -Infinity
    T(0, -2, -1e6 - 1);
    T(0, -0.2, 1e6 + 1);
    T(Infinity, -0.2, -1e6 - 1);            // Math.pow(-0.2, -1e6 - 1) == -Infinity
    T(0, 0.2, 1e6 + 1);
    T(Infinity, 0.2, -1e6 - 1);

    // The following differ to Math.pow as the exponent will be truncated to 0,
    ...
    T('-7e+0', '-7', 1);
    T('6.1095374220609e+13', '7816353', 2.435);
    T('-9.01e+2', '-901', 1);
    T('1.016984074247269470395836690098169093010136836967e+39', '21584.7', 9);
    T('1.497639134680472576e+18', '4316', 5.55);
    T('4.1717657571404248e+16', '346822', 3.00435);
    T('-8.983272e+1', '-89.83272', 1);
    T('5.308416e+6', '-48', 4);
    T('2.09764e+3', '45.8', 2.9999);
    T('3.83432050166120236679168e+23', '52088', 5);
    T('4.096e+3', '-4', 6.120937);
    ...
    T('1.587141827118019619140350040987490145402132153698899021243321868668968193390822866803131555419115810065' +
        '08901525889227579394470766224134369e+74', '175595288.8066529', 9);
    ...
    T('1.888497394256858387595532951034741052100428552247961627495355202904723558656e+3', '-6.592180609971056972',
        4);
    ...
    T('8.3043861038534085480857730707894983974895341475449922046323943309856240866914720437665233e+61',
        '7584431.953', 9);
    T('5.4787291089024129877918140548999194405505068584642366052046899220357579072497678119620025119214429570421' +
        '679076944647727607529032984620150444553526120397e+151', '72419131838243117', 9);
    ...
    T('3.05021119744369888239209417566581849921624834657246971302432870103990316674041818082170961e+89', '-82045' +
        '5414011161', 6);
    ...
    T('2.1320058778623362693743157943232639078619851096757416882191780337397507274264845664066920942408900138964' +
        '6413824e+92', '2444169945946508.968', 6);
    T('2.22147484530834915265639755288996e+8', '-14904.612860817114', 2);
    T('1.492078384275163354935132877205588401e+36', '-1105217899', 4);
    T('-8.706315974131812740752872336328574378946466095300435988405613445608906916485832445671913193616433992611' +
        '1276712486987242162931090900645752178720048529774274761e+31', '-3538.91793390607241', 9);
    ...
    T('3.3715504067877824494301254520391898692874566929517185069539454439093971130103103995461456226946881594407' +
        '231961561136789085959653748072704542114811853522742743643494246976010868257225332083632035616264964911458078' +
        '6938367825230347818905248996593031355662611333376e+4', '-3.68110925219710489918033269313682', 8);
    ...
    T('1.2933690030633029978317864458950890700698349292432976269804895466563737201880939364145851524416113479708' +
        '518067001609042030295271670130750045121e+14', '-7.62048571', 16);
    ...
    T('1.3497135645575897529253431118705664765245378061900400303221733155570426158512526184604071289685694603714' +
    ...
    T('-2.175250019420677231502945585316047309543226583810643532856810988679256810815060837059831560661631867460' +
        '91443633027643554689317160117967955473175500964155968361524273945120598810972722792061e+14', '-3.121741', 29);
    ...
    T('1.1504940871276742926708823617505372960241390892442547940194260102743306128298973371802547471453755938653' +
    ...
    T('179769313486231590772930519078902473361797697894230657273430081157732675805500963132708477322407536021120' +
        '113879871393357658789768814416622492847430639474124377767893424865485276302219601246094119453082952085005768' +
        '838150682342462881473913110540827237163350510684586298239947245938479716304835356329624224137216', 2, 1024);
    ...
    assertException(function () {
        new BigNumber(2).pow(4.4)
    }, ".pow(4.4)");
    assertException(function () {
        new BigNumber(2).pow('5.5')
    }, ".pow('5.5')");
    assertException(function () {
        new BigNumber(2).pow(-2.1)
    }, ".pow(-2.1)");
    assertException(function () {
        new BigNumber(2).pow('-11.5')
    }, ".pow('-11.5')");
    assertException(function () {
        new BigNumber(2).pow(0.99)
    }, ".pow(0.99)");
    assertException(function () {
        new BigNumber(2).pow('0.04e2')
    }, ".pow('0.04e2')");

    assertException(function () {
        new BigNumber('12.345').pow(undefined)
    }, ".pow(undefined)");
    assertException(function () {
        new BigNumber('12.345').pow(null)
    }, ".pow(null)");
    assertException(function () {
        new BigNumber('12.345').pow(true)
    }, ".pow(true)");
    assertException(function () {
        new BigNumber('12.345').pow(false)
    }, ".pow(false)");
    assertException(function () {
        new BigNumber('12.345').pow(NaN)
    }, ".pow(NaN)");
    assertException(function () {
        new BigNumber('12.345').pow('NaN')
    }, ".pow('NaN')");
    assertException(function () {
        new BigNumber('12.345').pow([])
    }, ".pow([])");
    assertException(function () {
        new BigNumber('12.345').pow({})
    }, ".pow({})");
    ...
    assertException(function () {
        new BigNumber('12.345').pow('2e+1')
    }, ".pow('2e+1')");
    assertException(function () {
        new BigNumber('12.345').pow('4e')
    }, ".pow('4e')");
    assertException(function () {
        new BigNumber('12.345').pow('hello')
    }, ".pow('hello')");
    assertException(function () {
        new BigNumber('12.345').pow('\t')
    }, ".pow('\t')");
    assertException(function () {
        new BigNumber('12.345').pow(new Date)
    }, ".pow(new Date)");
    assertException(function () {
        new BigNumber('12.345').pow(new RegExp)
    }, ".pow(new RegExp)");
    assertException(function () {
        new BigNumber('12.345').pow(function () {
        })
    }, ".pow(function (){})");
    assertException(function () {
        new BigNumber('12.345').pow(7.5)
    }, ".pow(7.5)");
    assertException(function () {
        new BigNumber('12.345').pow('1.1e1')
    }, ".pow('1.1e1')");

    assertException(function () {
        new BigNumber('12.345').pow(1e9 + 1)
    }, ".pow(1e9 + 1)");
    assertException(function () {
        new BigNumber('12.345').pow(1e9 + 0.1)
    }, ".pow(1e9 + 1)");
    assertException(function () {
        new BigNumber('12.345').pow('-0.01')
    }, ".pow('-0.01')");
    assertException(function () {
        new BigNumber('12.345').pow('-1e-1')
    }, ".pow('-1e-1')");
    assertException(function () {
        new BigNumber('12.345').pow(Infinity)
    }, ".pow(Infinity)");
    assertException(function () {
        new BigNumber('12.345').pow('-Infinity')
    }, ".pow('-Infinity')");
    ...
    assertException(function () {
        new BigNumber(1).pow(MAX_POWER + 1)
    }, ".pow(MAX_POWER + 1)");
    T(1, 1, MAX_POWER);
