var count = (function toPrecision(BigNumber) {
    ...
    assertException(function () {
        new BigNumber(1.23).toPrecision(NaN)
    }, "(1.23).toPrecision(NaN)");
    assertException(function () {
        new BigNumber(1.23).toPrecision('NaN')
    }, "(1.23).toPrecision('NaN')");
    assertException(function () {
        new BigNumber(1.23).toPrecision([])
    }, "(1.23).toPrecision([])");
    assertException(function () {
        new BigNumber(1.23).toPrecision({})
    }, "(1.23).toPrecision({})");
    ...
    assertException(function () {
        new BigNumber(1.23).toPrecision('hello')
    }, "(1.23).toPrecision('hello')");
    assertException(function () {
        new BigNumber(1.23).toPrecision('\t')
    }, "(1.23).toPrecision('\t')");
    assertException(function () {
        new BigNumber(1.23).toPrecision(new Date)
    }, "(1.23).toPrecision(new Date)");
    assertException(function () {
        new BigNumber(1.23).toPrecision(new RegExp)
    }, "(1.23).toPrecision(new RegExp)");
    assertException(function () {
        new BigNumber(1.23).toPrecision(2.01)
    }, "(1.23).toPrecision(2.01)");
    assertException(function () {
        new BigNumber(1.23).toPrecision(10.5)
    }, "(1.23).toPrecision(10.5)");
    assertException(function () {
        new BigNumber(1.23).toPrecision('1.1e1')
    }, "(1.23).toPrecision('1.1e1')");
    assertException(function () {
        new BigNumber(1.23).toPrecision(true)
    }, "(1.23).toPrecision(true)");
    assertException(function () {
        new BigNumber(1.23).toPrecision(false)
    }, "(1.23).toPrecision(false)");
    assertException(function () {
        new BigNumber(1.23).toPrecision(function () {
        })
    }, "(1.23).toPrecision(function (){})");

    assertException(function () {
        new BigNumber('12.345e1').toPrecision('-1')
    }, ".toPrecision('-1')");
    assertException(function () {
        new BigNumber('12.345e1').toPrecision(-23)
    }, ".toPrecision(-23)");
    assertException(function () {
        new BigNumber('12.345e1').toPrecision(1e9 + 1)
    }, ".toPrecision(1e9 + 1)");
    assertException(function () {
        new BigNumber('12.345e1').toPrecision(1e9 + 0.1)
    }, ".toPrecision(1e9 + 0.1)");
    assertException(function () {
        new BigNumber('12.345e1').toPrecision(0)
    }, ".toPrecision(0)");
    assertException(function () {
        new BigNumber('12.345e1').toPrecision('-0')
    }, ".toPrecision('-0')");
    assertException(function () {
        new BigNumber('12.345e1').toPrecision(0.9)
    }, ".toPrecision(0.9)");
    assertException(function () {
        new BigNumber('12.345e1').toPrecision('-1e-1')
    }, ".toPrecision('-1e-1')");
    assertException(function () {
        new BigNumber('12.345e1').toPrecision(Infinity)
