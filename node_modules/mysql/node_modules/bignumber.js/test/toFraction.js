var count = (function toFraction(BigNumber) {
    ...
    assertException(function () {
        new BigNumber('12.3e1').toFraction('')
    }, ".toFraction('')");
    assertException(function () {
        new BigNumber('12.3e1').toFraction(' ')
    }, ".toFraction(' ')");
    ...
    assertException(function () {
        new BigNumber('12.3e1').toFraction(NaN)
    }, ".toFraction(NaN)");
    assertException(function () {
        new BigNumber('12.3e1').toFraction('NaN')
    }, ".toFraction('NaN')");
    assertException(function () {
        new BigNumber('12.3e1').toFraction('hello')
    }, ".toFraction('hello')");
    assertException(function () {
        new BigNumber('12.3e1').toFraction([])
    }, ".toFraction([])");
    ...
    assertException(function () {
        new BigNumber('12.3e1').toFraction(true)
    }, ".toFraction(true)");
    assertException(function () {
        new BigNumber('12.3e1').toFraction(false)
    }, ".toFraction(false)");
    assertException(function () {
        new BigNumber('12.3e1').toFraction(function () {
        })
    }, ".toFraction(function (){})");
    assertException(function () {
        new BigNumber('12.3e1').toFraction(new Number)
    }, ".toFraction(new Number)");
    assertException(function () {
        new BigNumber('12.3e1').toFraction(new String)
    }, ".toFraction(new String)");
    assertException(function () {
        new BigNumber('12.3e1').toFraction(new Date)
    }, ".toFraction(new Date)");
    assertException(function () {
        new BigNumber('12.3e1').toFraction(new RegExp)
    }, ".toFraction(new RegExp)");

    assertException(function () {
        new BigNumber('12.3e1').toFraction(7.5)
    }, ".toFraction(7.5)");
    assertException(function () {
        new BigNumber('12.3e1').toFraction(new BigNumber('225.435435'))
    }, ".toFraction(new BigNumber('225.435435'))");
    assertException(function () {
        new BigNumber('12.3e1').toFraction(0)
    }, ".toFraction(0)");
    assertException(function () {
        new BigNumber('12.3e1').toFraction('0.99')
    }, ".toFraction('0.99')");
    assertException(function () {
        new BigNumber('12.3e1').toFraction(-1)
    }, ".toFraction(-1)");
    assertException(function () {
        new BigNumber('12.3e1').toFraction(-23)
    }, ".toFraction(-23)");
    assertException(function () {
        new BigNumber('12.3e1').toFraction(Infinity)
    }, ".toFraction(Infinity)");
    assertException(function () {
        new BigNumber('12.3e1').toFraction('-Infinity')
    }, ".toFraction('-Infinity')");
