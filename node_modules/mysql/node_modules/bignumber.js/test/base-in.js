var count = (function baseIn(BigNumber) {
    ...
    assertException(function () {
        new BigNumber('2', 0).toString()
    }, "('2', 0)");
    assertException(function () {
        new BigNumber('2', 2).toString()
    }, "('2', 2)");
    assertException(function () {
        new BigNumber('2', '-2').toString()
    }, "('2', '-2')");
    assertException(function () {
        new BigNumber('0.000g', 16).toString()
    }, "('0.000g', 16)");
    assertException(function () {
        new BigNumber('453.43', 4).toString()
    }, "('453.43', 4)");
    assertException(function () {
        new BigNumber('1', 1).toString()
    }, "('1', 1)");
    assertException(function () {
        new BigNumber('1.23', 36.01).toString()
    }, "('1.23', 36.01)");
    assertException(function () {
        new BigNumber('1.23', 37).toString()
    }, "('1.23', 37)");

    assertException(function () {
        new BigNumber(12.345, NaN).toString()
    }, "(12.345, NaN)");
    assertException(function () {
        new BigNumber(12.345, 'NaN').toString()
    }, "(12.345, 'NaN')");
    assertException(function () {
        new BigNumber(12.345, []).toString()
    }, "(12.345, [])");
    assertException(function () {
        new BigNumber(12.345, {}).toString()
    }, "(12.345, {})");
    ...
    assertException(function () {
        new BigNumber(12.345, 'hello').toString()
    }, "(12.345, 'hello')");
    assertException(function () {
        new BigNumber(12.345, '\t').toString()
    }, "(12.345, '\t')");
    assertException(function () {
        new BigNumber(12.345, new Date).toString()
    }, "(12.345, new Date)");
    assertException(function () {
        new BigNumber(12.345, new RegExp).toString()
    }, "(12.345, new RegExp)");
    assertException(function () {
        new BigNumber(101, 2.02).toString()
    }, "(101, 2.02)");
    assertException(function () {
        new BigNumber(12.345, 10.5).toString()
    }, "(12.345, 10.5)");
