var count = (function toFixed(BigNumber) {
    ...
    assertException(function () {
        new BigNumber(1.23).toFixed(NaN)
    }, "(1.23).toFixed(NaN)");
    assertException(function () {
        new BigNumber(1.23).toFixed('NaN')
    }, "(1.23).toFixed('NaN')");
    assertException(function () {
        new BigNumber(1.23).toFixed([])
    }, "(1.23).toFixed([])");
    assertException(function () {
        new BigNumber(1.23).toFixed({})
    }, "(1.23).toFixed({})");
    ...
    assertException(function () {
        new BigNumber(1.23).toFixed('hello')
    }, "(1.23).toFixed('hello')");
    assertException(function () {
        new BigNumber(1.23).toFixed('\t')
    }, "(1.23).toFixed('\t')");
    assertException(function () {
        new BigNumber(1.23).toFixed(new Date)
    }, "(1.23).toFixed(new Date)");
    assertException(function () {
        new BigNumber(1.23).toFixed(new RegExp)
    }, "(1.23).toFixed(new RegExp)");
    assertException(function () {
        new BigNumber(1.23).toFixed(2.01)
    }, "(1.23).toFixed(2.01)");
    assertException(function () {
        new BigNumber(1.23).toFixed(10.5)
    }, "(1.23).toFixed(10.5)");
    assertException(function () {
        new BigNumber(1.23).toFixed('1.1e1')
    }, "(1.23).toFixed('1.1e1')");
    assertException(function () {
        new BigNumber(1.23).toFixed(true)
    }, "(1.23).toFixed(true)");
    assertException(function () {
        new BigNumber(1.23).toFixed(false)
    }, "(1.23).toFixed(false)");
    assertException(function () {
        new BigNumber(1.23).toFixed(function () {
        })
    }, "(1.23).toFixed(function (){})");

    assertException(function () {
        new BigNumber('12.345e1').toFixed('-1')
    }, ".toFixed('-1')");
    assertException(function () {
        new BigNumber('12.345e1').toFixed(-23)
    }, ".toFixed(-23)");
    assertException(function () {
        new BigNumber('12.345e1').toFixed(1e9 + 1)
    }, ".toFixed(1e9 + 1)");
    assertException(function () {
        new BigNumber('12.345e1').toFixed(1e9 + 0.1)
    }, ".toFixed(1e9 + 1)");
    assertException(function () {
        new BigNumber('12.345e1').toFixed('-0.01')
    }, ".toFixed('-0.01')");
    assertException(function () {
        new BigNumber('12.345e1').toFixed('-1e-1')
    }, ".toFixed('-1e-1')");
    assertException(function () {
        new BigNumber('12.345e1').toFixed(Infinity)
    }, ".toFixed(Infinity)");
    assertException(function () {
        new BigNumber('12.345e1').toFixed('-Infinity')
    }, ".toFixed('-Infinity')");
